/**
It was tricky to accomplish the Thumbnail Toolbar Buttons because MinGW is missing some Win32 API files.
I've considered MSVC and MinGW64, but I wish to keep it MinGW compatible.
So this file is intented to define what's is missing on MinGW.
"Credits where it's due": nicug.blogspot.com.br/2011/03/windows-7-taskbar-extensions-in-qt.html

The code below is unnecessary when using MSVC or MinGW64, just include "shlobj.h".
**/
